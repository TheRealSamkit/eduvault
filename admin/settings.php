                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text"><?php echo $settings_data['site_name']['description']; ?></div>
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Site Description</label>
                                        <textarea class="form-control" name="settings[site_description]" rows="3"
                                        ><?php echo htmlspecialchars($settings_data['site_description']['setting_value']); ?></textarea>
                                        <div class="form-text"><?php echo $settings_data['site_description']['description']; ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">Current: <?php echo formatBytes($settings_data['max_file_size']['setting_value']); ?></div>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="form-text">Comma-separated list of file extensions (e.g., pdf,doc,docx)</div>
                                    </div>
                                </div>
