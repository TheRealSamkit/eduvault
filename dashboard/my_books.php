...
if (isset($_POST['delete_book'])) {
    ...
    $book_query = "SELECT image_path FROM book_listings WHERE id = $book_id AND user_id = $user_id";
    $book_result = mysqli_query($mysqli, $book_query);
    $book = mysqli_fetch_assoc($book_result);
    if ($book) {
        $book['image_path'] = str_replace('/eduvault', '..', $book['image_path']);
        if (file_exists($book['image_path'])) {
            ...
            flash('error', 'Error while removing image.');
