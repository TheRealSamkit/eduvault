...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 05, 2025 at 05:42 PM
...
(1, 'admin', '$2y$10$Q9oTT87zOSUl1wat6LkUSuf/F2ehpzSBl4NOfAMtkp1uEqKYxZGmi', 'super_admin', '2025-06-05 15:28:49', '2025-06-02 13:30:16');
...
INSERT INTO `book_listings` (`id`, `user_id`, `title`, `subject`, `board`, `status`, `image_path`, `location`, `created_at`) VALUES
(20, 7, 'Mathematics Grade 10', 'Mathematics', 'CBSE', 'Available', NULL, 'Delhi', '2025-06-02 13:19:48'),
(21, 8, 'Biology Textbook', 'Biology', 'ICSE', 'Available', NULL, 'Mumbai', '2025-06-02 13:19:48'),
(23, 5, 'Chemistry Handbook', 'Chemistry', 'GBSE', 'Available', NULL, 'Ahmedabad', '2025-06-02 13:19:48'),
(24, 6, 'History of India', 'History', 'RBSE', 'Available', NULL, 'Jaipur', '2025-06-02 13:19:48'),
(25, 4, 'Economics Basics', 'Economics', 'CBSE', 'Donated', NULL, 'Kolkata', '2025-06-02 13:19:48'),
(26, 12, 'Computer Science Intro', 'Computer Science', 'CBSE', 'Available', NULL, 'Pune', '2025-06-02 13:19:48'),
(27, 3, 'Political Science Notes', 'Political Science', 'ICSE', 'Available', NULL, 'Lucknow', '2025-06-02 13:19:48'),
(29, 6, 'Environmental Science', 'EVS', 'CBSE', 'Available', NULL, 'Hyderabad', '2025-06-02 13:19:48'),
(30, 7, 'Business Studies', 'Business', 'ICSE', 'Available', NULL, 'Indore', '2025-06-02 13:19:48'),
(31, 11, 'Geography Today', 'Geography', 'RBSE', 'Donated', NULL, 'Surat', '2025-06-02 13:19:48'),
(32, 13, 'Sociology Handbook', 'Sociology', 'CBSE', 'Available', NULL, 'Nagpur', '2025-06-02 13:19:48'),
(33, 4, 'Psychology 101', 'Psychology', 'ICSE', 'Available', NULL, 'Patna', '2025-06-02 13:19:48'),
(34, 15, 'Philosophy Made Easy', 'Philosophy', 'CBSE', 'Donated', NULL, 'Bhopal', '2025-06-02 13:19:48'),
(35, 17, 'Anything', 'Test-1', 'ICSE', 'Available', '../images/books/683da6f9ed511.png', 'Ahmedabad', '2025-06-02 13:28:25');
...
(16, 1, 'Wt', 'Web Technologies', '../uploads/files/683d2f6c4cc34.pdf', 'Web Technologies', 'Diploma', '2025', 'pdf', '2025-06-02 04:58:20');
...
(16, 16, 1, '2025-06-02 04:59:11'),
(17, 16, 1, '2025-06-02 05:00:01'),
(18, 2, 1, '2025-06-02 05:00:06'),
(19, 16, 17, '2025-06-02 13:31:45');
...
(16, 16, 1, 5, 'Good Condition', '2025-06-02 05:03:16');
...
CREATE TABLE `users` (
  ...
  `status` enum('bloacked','active') NOT NULL DEFAULT 'active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
...
(1, 'Samkit Jain', 'samkitjain2809@gmail.com', '$2y$10$3s1LHsivZ/y3archrvIUv.po80WFqwfH7zZ8bWG5TADhkHNRc5K0y', 'Ahmedabad', '8200700139', 'active', '2025-05-31 15:39:16', NULL, 22.00030000, 73.20650000),
(3, 'Ravi Verma', 'ravi.verma@example.com', '$2y$10$c2CQjSIQXG4v6.oqXYxWluAfYzY/wpA5.zkZOrHIlfedOwLGWkK.G', 'Lucknow', '9876543211', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(4, 'Meena Shah', 'meena.shah@example.com', '$2y$10$Xqe1hLcZ42oK02SvDpo0M.JDbB0/OUtQrgp6pgEdtJd11e4lkPl9K', 'Jaipur', '9876543212', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(5, 'Rahul Kapoor', 'rahul.kapoor@example.com', '$2y$10$5K6CfmOfdSOg7u3ZEEeOF.2o2xUzNLiFfMPikXzwUVJVOM3kd3kru', 'Delhi', '9876543213', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(6, 'Tina Dsouza', 'tina.dsouza@example.com', '$2y$10$oSOM/XqHzzZIAwUdYmoXfuk0gtI7X1uT0tZ68s/b1IE8T4EkEDPDm', 'Mumbai', '9876543214', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(7, 'Karan Mehta', 'karan.mehta@example.com', '$2y$10$Gg8cdbHcWYljlqRTXauM6eik7dbbjGcTDc6lbMcChJoZR7Gc3WOSC', 'Pune', '9876543215', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(8, 'Deepa Reddy', 'deepa.reddy@example.com', '$2y$10$5ARWwHzQYI2xDJfMYfjO7e7b49RwHBKN9DICO4hN9p08FG2ismxa.', 'Hyderabad', '9876543216', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(10, 'Sneha Nair', 'sneha.nair@example.com', '$2y$10$5znB6Qrkj8Czr2qGCKgINeX976.NiiL3.t9GPaqMS3LO1VkS/u74K', 'Chennai', '9876543218', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(11, 'Amit Kulkarni', 'amit.kulkarni@example.com', '$2y$10$uw8jdI.GEf5iIIkcYl0zNe9UFcNCbwNtZwLdcLBFvsUXwTxasI85i', 'Nagpur', '9876543219', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(12, 'Neha Gupta', 'neha@gmail.com', '$2y$10$yOlaZ1iqBCfGYbVthxwcSOrrMmjSRFag6kpBuXfa0QuJ.ObOVLA16', 'Bhopal', '9876543220', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(13, 'Pooja Bhatt', 'pooja.bhatt@example.com', '$2y$10$sqwGyl7ZwEje5uF3XZzxCO9NxqShkbgSHN3g2B6/8bDk02Ih5BzZ2', 'Patna', '9876543221', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(14, 'Vikram Singh', 'vikram.singh@example.com', '$2y$10$0OiG4lf1UOnHeu9hMDMnIemRE4.2cF4N2f7DwpQUTt4zS01UU7gTK', 'Varanasi', '9876543222', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(15, 'Harshita Rana', 'harshita.rana@example.com', 'hashed_password_14', 'Chandigarh', '9876543223', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(16, 'Arjun Das', 'arjun.das@example.com', 'hashed_password_15', 'Kolkata', '9876543224', 'active', '2025-06-01 12:44:59', NULL, NULL, NULL),
(17, 'Jay ', 'Jay@gmail.com', '$2y$10$UpehAoopPoB1LcJnjVBz7e5gIdo31vemIxgfvHwO.rUkdWHQEDki2', 'Vadodara', '9876456252', 'active', '2025-06-02 05:25:59', NULL, 23.02250500, 72.57136210);
